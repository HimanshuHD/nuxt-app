  ...
  <main class="page weather-page">
    <div class="content weather-content">
      ...
      <section class="location-panel" aria-labelledby="location-heading">
        <div><p id="location-heading" class="section-label">Find a location</p><p class="section-help">Start typing to search. Choose a location from the results.</p></div>
        <div class="search-field-wrap">
          <label class="search-field"><span>City or location</span><div class="search-input-wrap"><input v-model="searchQuery" type="text" autocomplete="off" placeholder="e.g. Delhi, London, Tokyo" role="combobox" :aria-expanded="searchLoading || searchResults.length > 0" aria-controls="location-results" :aria-activedescendant="activeResultIndex >= 0 ? `location-result-${activeResultIndex}` : undefined" @input="scheduleLocationSearch" @keydown="handleSearchKeydown"><span v-if="searchLoading" class="search-loader" aria-label="Searching" role="status" /><button v-if="searchQuery" class="search-clear" type="button" aria-label="Clear location search" @click="clearSearch">×</button></div></label>
...
<style scoped>
.location-panel{position:relative;z-index:30}.search-field-wrap{position:relative;z-index:31}.search-field{display:grid;gap:.4rem;color:#cbd5e1;font-size:.8rem;font-weight:700}.search-input-wrap{position:relative}.search-field input{width:100%;min-width:0;padding:.8rem 5rem .8rem .9rem;border:1px solid rgba(255,255,255,.14);border-radius:10px;background:rgba(0,0,0,.18);color:#f8fafc;font:inherit}.search-field input::-webkit-search-cancel-button{display:none}.search-loader{position:absolute;top:50%;right:2.75rem;width:15px;height:15px;transform:translateY(-50%);border:2px solid rgba(255,255,255,.22);border-top-color:#f8fafc;border-radius:50%;animation:spin .7s linear infinite;pointer-events:none}.search-clear{position:absolute;top:50%;right:.65rem;width:24px;height:24px;padding:0;border:0;border-radius:50%;transform:translateY(-50%);background:rgba(255,255,255,.08);color:#cbd5e1;font-size:1.15rem;line-height:1;cursor:pointer}.search-clear:hover{background:rgba(255,255,255,.15);color:#fff}.search-results{position:absolute;z-index:100;top:calc(100% + .45rem);right:0;left:0;display:grid;gap:.35rem;max-height:320px;overflow-y:auto;padding:.4rem;border:1px solid rgba(255,255,255,.12);border-radius:14px;background:rgba(15,23,42,.98);box-shadow:0 20px 50px rgba(0,0,0,.4)}.search-result{display:grid;gap:.2rem;width:100%;padding:.8rem .9rem;border:0;border-radius:10px;background:transparent;color:#f8fafc;text-align:left;cursor:pointer;font:inherit}.search-result:hover,.search-result--active{background:rgba(255,255,255,.08)}.search-result span{color:#94a3b8;font-size:.85rem}.search-error{margin:.45rem 0 0;color:#fecaca;font-size:.85rem}.advanced-search{position:relative;z-index:1;margin-bottom:1.25rem;border:1px solid rgba(255,255,255,.1);border-radius:14px;background:rgba(255,255,255,.025)}.advanced-search summary{padding:.9rem 1rem;color:#cbd5e1;font-weight:700;cursor:pointer}.advanced-search__content{display:grid;gap:1rem;padding:0 1rem 1rem}.weather-card--stable{min-height:430px;position:relative;z-index:1}.weather-empty{display:grid;min-height:390px;place-content:center;text-align:center}.weather-empty h2{margin:0 0 .5rem}.weather-empty p:last-child{margin:0;color:#94a3b8}.weather-location{min-width:0}.location-title{display:flex;align-items:center;gap:.75rem}.location-title h2{margin:0;font-size:clamp(1.8rem,4vw,2.75rem)}.country-flag{width:40px;height:27px;flex:0 0 auto;object-fit:cover;border-radius:4px;box-shadow:0 4px 12px rgba(0,0,0,.2)}.weather-visual-wrap{display:flex;align-items:center;gap:.5rem}.weather-visual-wrap .temperature{margin-top:.5rem}.skeleton{border-radius:8px;background:linear-gradient(90deg,rgba(255,255,255,.06),rgba(255,255,255,.13),rgba(255,255,255,.06));background-size:200% 100%;animation:shimmer 1.4s infinite}.skeleton-header{position:absolute;top:2rem;left:2rem;width:48%}.skeleton--eyebrow{width:110px;height:12px;margin-bottom:1rem}.skeleton--title{width:75%;height:38px;margin-bottom:.8rem}.skeleton--condition{width:45%;height:18px}.skeleton-temperature{position:absolute;top:1.6rem;right:2rem;display:flex;align-items:center;gap:.5rem}.skeleton--icon{width:80px;height:80px;border-radius:50%}.skeleton--temp{width:100px;height:64px}.skeleton-tile{padding:1rem;border-radius:14px;background:rgba(255,255,255,.04)}.skeleton--label{width:60%;height:12px;margin-bottom:.6rem}.skeleton--value{width:45%;height:18px}@keyframes shimmer{to{background-position:-200% 0}}@keyframes spin{to{transform:translateY(-50%) rotate(360deg)}}
@media(max-width:800px){.weather-visual-wrap{width:100%;justify-content:space-between}}
@media(max-width:640px){.search-field input{padding-right:5rem}.search-loader{right:2.75rem}.search-clear{right:.65rem}.location-title h2{font-size:1.7rem}.weather-visual{width:180px}.weather-visual-wrap{gap:0}.weather-visual-wrap .temperature img{width:60px;height:60px}.skeleton-header{top:1.25rem;left:1.25rem;width:55%}.skeleton-temperature{top:1rem;right:1.25rem}}
@media(prefers-reduced-motion:reduce){.search-loader,.skeleton{animation:none}}
</style>
